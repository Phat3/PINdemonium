...
int WINAPI ScyllaIatFixAutoW(DWORD_PTR iatAddr, DWORD iatSize, DWORD dwProcessId, const WCHAR * dumpFile, const WCHAR * iatFixFile, unsigned int eip, DWORD call_plugin_flag, const WCHAR * plugin_full_path, const WCHAR *reconstructed_imports_file);
